...
get_header(); ?>
		<!-- Content -->
		<?= (get_option('fbf_settings')['fbf_posizione_notizie_evidenza']=="sopra")?get_template_part('template-part/notizie-home'):""; ?>
		...
		<?= (get_option('fbf_settings')['fbf_posizione_notizie_evidenza']=="sotto")?get_template_part('template-part/notizie-home'):""; ?>
		<!-- /Content -->
<?php get_footer(); ?>