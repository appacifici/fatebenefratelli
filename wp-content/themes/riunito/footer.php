					...
					<?php if($is_sub_footer) { ?>
						...
						<div class="block-full sub-footer">
							<div class="block-inner">
								<div class="two-third sub-footer-column-1">&copy; Copyright <?php echo date("Y"); ?> - <?php echo ($footer_left?$footer_left:'&nbsp;') ?></div>
								<div class="one-third last sub-footer-column-2"><span style="float:left"><?php echo $icons_html ?></span></span></div>
								<div class="clear"></div>
							</div>
						</div>
